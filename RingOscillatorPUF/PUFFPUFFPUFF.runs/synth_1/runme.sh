...
HD_PWD='C:/Users/USER/VIVADOProjects/PUFFPUFFPUFF/PUFFPUFFPUFF.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PUFFD1DD4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PUFFD1DD4.tcl
