...
HD_PWD='C:/Users/USER/VIVADOProjects/PUFFPUFFPUFF/PUFFPUFFPUFF.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log PUFFD1DD4.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source PUFFD1DD4.tcl -notrace
