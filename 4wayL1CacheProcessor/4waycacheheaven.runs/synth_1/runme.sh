...
HD_PWD='C:/Users/USER/VIVADOProjects/4waycacheheaven/4waycacheheaven.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log otter_tb.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source otter_tb.tcl
